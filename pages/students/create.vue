<template>
    ...
    <div>
        ...
        :class="{
            ...
            $v.student.first_name.$dirty && $v.student.first_name.$invalid,
        }"
        />
        <p
        v-if="!$v.student.first_name.required && $v.student.first_name.$dirty"
    ...
    <div>
        ...
        />
        <p
        v-if="!$v.student.last_name.required && $v.student.last_name.$dirty"
        class="text-red-500 text-xs mt-2"
        >
        Last Name is required.
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-10">
                    <div>
                        ...
                        />
                        <p
                            v-if="!$v.student.roll_number.required && $v.student.roll_number.$dirty"
                            class="text-red-500 text-xs mt-2"
                        >
                    ...
                    <div class="">
                        ...
                        <input id="reg_number" name="reg_number" type="text"
                            ...
                            placeholder="Registration Number"  v-model.trim="student.reg_number" class="appearance-none
                            block
                            w-full
                            px-4
                            py-3
                    ...
                    <div>
                        ...
                        <div class="flex flex-col lg:flex-row">
                            ...
                            <select
                                ...
                                :class="{
                            'border border-red-500':
                                $v.student.class.$dirty &&
                                $v.student.class.$invalid,
                            }"
                            >
                            <option value="">Select Class</option>
                                <option v-for="(item, index) in classList.options" :key="index" :value="item.value">{{ item.name }}</option>
                    ...
                    <div>
                        ...
                        <div class="flex flex-col lg:flex-row">
                            ...
                            <select
                                ...
                                :class="{
                            'border border-red-500':
                                $v.student.group.$dirty &&
                                $v.student.group.$invalid,
                            }"
                            >
                ...
                <div class="flex flex-col lg:flex-row">
                    ...
                    <select
                        ...
                        :class="{
                    'border border-red-500':
                        $v.student.gender.$dirty &&
                        $v.student.gender.$invalid,
                    }"
                    >
                    <option value="">Select Group</option>
                        <option v-for="(item, index) in gender.options" :key="index" :value="item.value">{{ item.name }}</option>
                    ...
                    <div>
                        ...
                        <div class="flex flex-col lg:flex-row">
                            ...
                            <option value="">Select Student Type</option>
                                <option v-for="(item, index) in studentType.options" :key="index" :value="item.value">{{ item.name }}</option>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-10 mt-6">
                    <div>
                        ...
                        <div class="flex flex-col lg:flex-row">
                            ...
                            >
                            <option value="">Select Class</option>
                                <option v-for="(item, index) in fourthSubjectList.options" :key="index" :value="item.value">{{ item.name }}</option>
                ...
                <p
                    v-if="!$v.twoSubjects.optional.required && $v.twoSubjects.optional.$dirty"
                    class="text-red-500 text-xs mt-2"
                >

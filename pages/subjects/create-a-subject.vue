        ...
        <div>
            <form @submit.prevent="uploadASubject">
                ...
                <div class="p-10">
                    ...
                    <div class="sm:grid sm:grid-cols-2 gap-x-10 py-4 inputText-border">
                        <div class="pb-4 sm:pb-0">
                            <SelectInputMultiPart :shadowStudent="shadowStudent" :marginBottom="marBottom" :widthStudent="widthStudent" :value="subject.has_multipart" :input="multiPart" @hello="multiPartChanged"/>
                            <span v-if="!$v.subject.has_multipart.required && $v.subject.has_multipart.$dirty" class="error pb-4">*Multipart is required</span>
                        </div>
                        <div class="pb-4 sm:pb-0">
                            <SelectInputSubjectType :shadowStudent="shadowStudent" :marginBottom="marBottom" :widthStudent="widthStudent" :value="subject.subject_type" :input="subjectType" @hello="subjectChanged"/>
                            <span v-if="!$v.subject.subject_type.required && $v.subject.subject_type.$dirty" class="error pb-4">*Subject Type is required</span>
                        </div>
                    </div> 
                    <div class="sm:grid sm:grid-cols-2 gap-x-10 py-4 inputText-border">
                        <div class="pb-4 sm:pb-0">
                            <SelectInputOptional :shadowStudent="shadowStudent" :marginBottom="marBottom" :widthStudent="widthStudent" :value="subject.can_be_optional" :input="optional" @hello="optionalChanged"/>
                            <span v-if="!$v.subject.can_be_optional.required && $v.subject.can_be_optional.$dirty" class="error pb-4">*Optional is required</span>
                        </div>
                    </div> 
                ...
                <div v-if="isError('postCreateSubject')  && isError('postCreateSubject').has_error" class="pt-3">
                    <h1 class="font text-red-600"> {{ isError('postCreateSubject').error }} </h1>
                </div>
